...
* The scope of the Confidential Computing Consortium (CCC) is to
  "promote the widespread use of hardware-attested trusted execution
  environments".
...
* "promote the widespread use of hardware-attested trusted execution environments".

This proposal puts the focus on hardware-attested TEEs, while providing
