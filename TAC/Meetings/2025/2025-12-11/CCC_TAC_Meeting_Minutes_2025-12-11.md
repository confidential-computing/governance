...
* Dan Middleton (DM) opened the call at 8:04 am PT
...
* Benny Fuhry
* Caroline (MSFT)  
* Ding (Confidential Containers/Alibaba)  
* Henk Birkholz
* Jeff Kuhn  
...
Rene Kolga introduced themselves to the meeting.
...
He shared the TAC Topics for 2026, which need to be planned. DM shared that the next TAC meeting will be on January 08, 2026, and today’s meeting will be the last one for this year. [Later the first meeting was pushed back to Jan 22.]
...
Yash Mankad announced that he would send out a year-end review for the TAC early next week, highlighting the group's achievements, including the launch of the TWI SIG and voting on project proposals.

## New Business
Ding presented Trustee, a general-purpose attestation verifier and broker designed to standardise attestation protocols and key management across different clouds and Trusted Execution Environments (TEEs).  The TAC members discussed the architecture and functionality of the Trustee service, focusing on its alignment with the RATS (Remote Attestation Service) model.
[Slide](CCC_Trustee_Presentation_2025-12-11.pdf)

## Thanks, Yash!
DM extended thanks to Yash for his contributions as Vice Chair and his work on the mentor program.

## Any Other Business / Topic Schedule 2025

Next meeting is scheduled on January 08,2026. The meeting was adjourned by DM at 08:59 am PT
