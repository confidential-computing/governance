...
DT asked for clarification which Open Enclave SDK this represents, as there are different versions for Windows and Linux. RJ noted that this talk is specific to Open Enclave SDK for Linux.
...
**Action:** Brian Warner to investigate prior efforts to finalize Graduated lifecycle language, and if needed file an issue to finalize Graduated lifecycle language.
