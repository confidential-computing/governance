...
* Thomas Fossati (Arm) P


#### Attendees

* Eric Voit (Cisco) P 
* Penglin Yang (China Mobile) P
* Dan Middleton (Intel) P
* Steve Van Lare (Anjuna) P
...
#### Also Participating
* Kurt Taylor (Linux Foundation) P
...
### TAC Tech Talks
 *  Code Scanning via LFX Security Shubhra Kar (Linux Foundation)
